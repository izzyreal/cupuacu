...
namespace
{
                                                 ...
                                                 cupuacu::gui::Component *handle)
    {
        ...
        REQUIRE(handle->mouseDown(
            cupuacu::test::integration::localComponentMouseEvent(
                handle, cupuacu::gui::DOWN, 2, true)));
        ...
        REQUIRE(mainWindow->handleMouseEvent(
            cupuacu::test::integration::componentMouseEvent(
                handle, cupuacu::gui::UP, 2, true)));
          ...
          "[integration]")
{
    ...
    auto *okButton =
        cupuacu::test::integration::findByNameRecursive<cupuacu::gui::TextButton>(
            root, "TextButton:OK");
    cupuacu::test::integration::clickButton(okButton);
          ...
          "[integration]")
{
    ...
    cupuacu::test::integration::moveMouseOverComponent(mainWindow, hoverHandle);
    auto *hoveredMarkerComponent = mainWindow->getComponentUnderMouse();
    REQUIRE(hoveredMarkerComponent != nullptr);

    mainWindow->setComponentUnderMouse(nullptr);
    cupuacu::test::integration::moveMouseOverComponent(mainWindow, underlay);
          ...
          "[integration]")
{
    ...
    cupuacu::test::integration::clickComponentThroughWindow(dialogWindow,
                                                            applyButton);
